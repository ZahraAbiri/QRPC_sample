...
//public class Usage {
//    static Logger logger = LoggerFactory.getLogger(Usage.class);
//
//    public static void main(String[] args) throws InterruptedException {
//        //The usePlaintext() method is called to disable SSL/TLS, allowing for unencrypted communication (suitable for local development).
